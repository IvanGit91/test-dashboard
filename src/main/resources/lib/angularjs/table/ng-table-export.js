        ...
        return {
            ...
            link: function(scope, element, attrs) {
                    ...
                    angular.forEach(rows, function(row, i) {
                        ...
                        if (i !== 1) {
                            angular.forEach(tds, function(td) {
                                ...
                                var str = angular.element(td).text().trim();
                                if (str === "" || str === "Actions" || str === "Select" || str.startsWith("$(function ()")){
                                } else {
                                    rowData += stringify(str) + Array.apply(null, Array(td.colSpan)).map(function () {
                                        return delimiter;
                                    }).join('');
                                }
                            });
                ...
                var csv = {
                     ...
                     */
                    generate: function(event, filename, table, $scope) {
